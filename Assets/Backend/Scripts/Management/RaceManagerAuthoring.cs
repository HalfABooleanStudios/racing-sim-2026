...
public class RaceConfig : IComponentData
{
...
public struct RaceState : IComponentData
{
    
}

public class RaceManagerAuthoring : MonoBehaviour
{
    public static RaceManagerAuthoring Instance { get; private set; }


    class Baker : Baker<RaceManagerAuthoring>
    {
        public override void Bake(RaceManagerAuthoring authoring)
        {
